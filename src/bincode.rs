...
// https://github.com/bincode-org/bincode/blob/v2.0.0/src/features/impl_std.rs#L434-L496.

impl<T: Encode> Encode for Slab<T> {
    fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
        // https://docs.rs/bincode/2.0.0/bincode/config/struct.Configuration.html#method.with_fixed_int_encoding
...
impl<T, Context> Decode<Context> for Slab<T>
where
    T: Decode<Context>,
{
...
impl<'de, T, Context> BorrowDecode<'de, Context> for Slab<T>
where
